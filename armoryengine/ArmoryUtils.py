...
ARMORY_DONATION_ADDR = 'PMNgriEn2rrz38veKnm7YyBQK7xV79j1su'
ARMORY_DONATION_PUBKEY = ( '04'
      'DF67CFE6D85AF606345AF0EACC8B4F42AFD5AADE9D4E6638B584F610B98025BE'
      'D0BB85CEB0326F774CD15E7216F0F6A44FE301BBC74164725577D205FD407D8D')
ARMORY_INFO_SIGN_ADDR = 'PNBDQqpNpf6mTeV9NvcgwN7TDvZm2kxVsT'
ARMORY_INFO_SIGN_PUBLICKEY = ('04'
      'FE6A8C05BDA623634D98621719259D80BD80429C67803B4664287A189DAE34F4'
      'ADFA88D19CBC97FEC777655341B46CE6D7C717C56FC93110B31C95919AF41275')
...
if OS_WINDOWS:
   ...
   BLKFILE_1stFILE = os.path.join(BLKFILE_DIR, 'blk0001.dat')
elif OS_LINUX:
   OS_NAME         = 'Linux'
...
if not USE_TESTNET:
   ...
   BLOCKEXPLORE_URL_TX   = 'https://blockchain.info/tx/info/%s'
   BLOCKEXPLORE_URL_ADDR = 'https://blockchain.info/address/info/%s'
else:
   BITCOIN_PORT = 9903
